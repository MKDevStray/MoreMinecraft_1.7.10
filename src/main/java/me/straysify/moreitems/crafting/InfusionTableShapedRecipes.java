...
public class InfusionTableShapedRecipes implements IRecipe {
    ...
    public InfusionTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public InfusionTableShapedRecipes func_92100_c()
    {
