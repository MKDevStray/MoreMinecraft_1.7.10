package me.straysify.moreitems.ai;
...
public class EntityAIShadowCreeperSwell extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityShadowCreeper swellingCreeper;
    /** The creeper's attack target. This is used for the changing of the creeper's state. */
    EntityLivingBase creeperAttackTarget;
    private static final String __OBFID = "CL_00001614";

    public EntityAIShadowCreeperSwell(EntityShadowCreeper p_i1655_1_)
    {
