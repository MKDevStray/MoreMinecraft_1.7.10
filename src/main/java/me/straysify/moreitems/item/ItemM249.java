...
public class ItemM249 extends Item { 

	public ItemM249(Item goldIngot) {
		this.setFull3D();
...
//		    	   double posZ = par3EntityPlayer.getLookVec().zCoord;
	       par2World.playSoundAtEntity(par3EntityPlayer, "mi:m249shoot", 0.5F, 1.0F);// / (itemRand.nextFloat() * 0.4F + 0.8F));
