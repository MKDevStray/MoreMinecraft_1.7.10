...
public class ItemDesertEagle extends Item { 
	...
	public ItemDesertEagle(Item goldIngot) {
		this.setFull3D();
	 ...
	 public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	   {
	    	   if(par3EntityPlayer.inventory.hasItem(ModMain.bullet44)) {
	           //--par1ItemStack.stackSize;
	    		   if(!par3EntityPlayer.capabilities.isCreativeMode) {
	    		   par3EntityPlayer.inventory.consumeInventoryItem(ModMain.bullet44);
	    		   }
...
//		    	   double posZ = par3EntityPlayer.getLookVec().zCoord;
	       par2World.playSoundAtEntity(par3EntityPlayer, "mi:deagleshoot", 0.5F, 1.0F);// / (itemRand.nextFloat() * 0.4F + 0.8F));
