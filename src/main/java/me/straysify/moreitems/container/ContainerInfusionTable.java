package me.straysify.moreitems.container;

import me.straysify.moreitems.ModMain;
import me.straysify.moreitems.crafting.InfusionTableCraftingManager;
...
public class ContainerInfusionTable extends Container {
	...
	public ContainerInfusionTable(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, InfusionTableCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != ModMain.infusionTable) {
			return false;
		}else{
