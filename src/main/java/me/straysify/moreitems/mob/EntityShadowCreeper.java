...
import me.straysify.moreitems.ai.EntityAIShadowCreeperSwell;
...
public class EntityShadowCreeper extends EntityMob
{
    /**
    ...
    public EntityShadowCreeper(World p_i1733_1_)
    {
        super(p_i1733_1_);
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAIShadowCreeperSwell(this));
...
//    }
    ...
    private void func_146077_cc()
    {
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.getPowered())
            {
                this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 12.0F, flag); //<---- Explosion Size
            }
            else
            {
                this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 12.0F, flag);
            }
	...
	private static void registerEntity() {
		createEntity(EntityShadowCreeper.class, "EntityShadowCreeper", 0x0F528C, 0x910A8D);
