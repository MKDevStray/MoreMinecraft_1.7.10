...
public class EntityBullet extends EntityThrowable
{
    ...
    public EntityBullet(World p_i1773_1_)
    {
        super(p_i1773_1_);
    }

    public EntityBullet(World p_i1774_1_, EntityLivingBase p_i1774_2_)
    {
  ...
  //  	this.worldObj.playSoundAtEntity(this, "mi:bulletpass", 1.0F, 1.0F);
    ...
    protected void onImpact(MovingObjectPosition p_70184_1_)
    {
        if (p_70184_1_.entityHit != null)
        {
            ...
            p_70184_1_.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 18.0F);//<--- Float = Damage;
        }
