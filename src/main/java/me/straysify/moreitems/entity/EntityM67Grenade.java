...
public class EntityM67Grenade extends EntityThrowable
{
    ...
    public EntityM67Grenade(World p_i1773_1_)
    {
        super(p_i1773_1_);
    }

    public EntityM67Grenade(World p_i1774_1_, EntityLivingBase p_i1774_2_)
    {
        super(p_i1774_1_, p_i1774_2_);
    }

    public EntityM67Grenade(World p_i1775_1_, double p_i1775_2_, double p_i1775_4_, double p_i1775_6_)
    {
...
//
    ...
    public void onUpdate()
    {
		...
		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX, this.posY + 0.2F, this.posZ, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX, this.posY - 0.2F, this.posZ, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ - 0.2F, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX + 0.2F, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX, this.posY, this.posZ + 0.2F, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("smoke", this.posX - 0.2F, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
		this.worldObj.spawnParticle("flame", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
        super.onUpdate();

        if (this.ticksInAir >= 180)
        {
            this.setDead();
        }
