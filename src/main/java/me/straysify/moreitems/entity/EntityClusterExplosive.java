...
public class EntityClusterExplosive extends Entity {
    ...
    public EntityClusterExplosive(World p_i1729_1_)
    {
        super(p_i1729_1_);
    ...
    public EntityClusterExplosive(World p_i1730_1_, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_, EntityLivingBase p_i1730_8_)
    {
        this(p_i1730_1_);
