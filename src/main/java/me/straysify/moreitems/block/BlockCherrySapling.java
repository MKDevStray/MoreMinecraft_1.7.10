...
public class BlockCherrySapling extends BlockBush implements IGrowable
{
    ...
    public BlockCherrySapling(Material plants) {
    	float f = 0.4F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, f * 2.0F, 0.5F + f);
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenBigTree(true) : new WorldGenCherryTree(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        ...
        switch (l)
        {
            ...
            case 3:
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenCherryTree(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                }
