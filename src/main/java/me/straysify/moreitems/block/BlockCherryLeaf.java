...
//    }
    ...
    {
        return Item.getItemFromBlock(ModMain.cherrySapling);
    }
    
    public Item getItemDropped1(int par1, Random rand1, int par2)
    {
        return ModMain.blazeIngot;
    }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        ret.add(new ItemStack(ModMain.cherry));
