...
public class BlockShadowGrass extends Block implements IGrowable {

	private IIcon field_149991_b;
	private IIcon field_149993_M;
	private IIcon field_149994_N;

	public BlockShadowGrass(Material ground) {
		super(ground);
	        ...
	        while (l < 128)
	        {
	            ...
	            while (true)
	            {
	                if (l1 < l / 16)
	                {
	                    ...
	                    if (p_149853_1_.getBlock(i1, j1 - 1, k1) == ModMain.shadowGrassBlock && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube())
	                    {
	                        ++l1;
	                        continue;
	                    }
