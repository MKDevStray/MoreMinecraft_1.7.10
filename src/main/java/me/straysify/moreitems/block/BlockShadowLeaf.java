...
public class BlockShadowLeaf extends BlockLeavesBase implements IShearable
{
    int[] field_150128_a;
    ...
    public BlockShadowLeaf(Material leaves) {
    	super(leaves, false);
    	this.setTickRandomly(true);
    	this.setHardness(0.2F);
    	this.setLightOpacity(1);
...
//    }
    ...
    {
        return Item.getItemFromBlock(ModMain.shadowSapling);
    }
...
//        drops.add(new ItemStack(ModMain.blazeIngot, world.rand.nextInt(3) + 1));
//        drops.add(new ItemStack(ModMain.cherrySapling, world.rand.nextInt(2) + 1));
//        return drops;
//    }
}