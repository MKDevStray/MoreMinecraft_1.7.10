...
public class ShadowGenLayerBiome extends GenLayer {

private List<BiomeEntry>[] biomes = new ArrayList[BiomeManager.BiomeType.values().length];
    
    private static final String __OBFID = "CL_00000555";

    public ShadowGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            biomes[desertIdx].add(new BiomeEntry(BiomeRegistry.biomeShadow, 10));
        }
        else
        {
